...
export const generalFaqGroups: { id: string; title: string; items: FaqItem[] }[] = [
  { id: "budget", title: "預算與付款", items: [
    { id: "total-cost", question: "網頁車價就是交車總價嗎？還有哪些費用？", answer: "網頁標示的是建議售價。請另外核對成交車價、保險、領牌及稅費、選配、貸款費用和另約運送費。已包含的項目不重複加算；已付訂金會抵車款。先拿到明細，再比較交車前支出與全期總成本。", sourceIds: ["consumer", "registration"], links: [{ href: "/guides#budget", label: "看購車預算與試算範例" }] },
    { id: "cash-or-loan", question: "現金、零利率或低月付，哪一種比較划算？", answer: "先取得各方案實際車價，再加總頭款、全部期款、尾期款及另收費用。低月付可能只是拉長期數或把金額留到後面；零利率也要看費用與折扣差異。請同時比較總費用年百分率、提前清償條件及自己的現金需求。", sourceIds: ["loan"], links: [{ href: "/guides#payment", label: "看貸款與保險比較清單" }, { href: "/#loan-calculator", label: "前往貸款試算" }] },
    { id: "insurance-coverage", question: "只買強制險夠嗎？「全險」到底包含什麼？", answer: "強制險提供法定範圍的人身傷亡保障，不包含車輛修復費用。對方財物損失、自己的車損與其他風險，需要分別確認相應險種。「全險」不是所有事故都賠的保證；請逐項核對保額、自負額及除外條款，再比較同條件保費。", sourceIds: ["insurance", "autoInsurance"], links: [{ href: "/guides#payment", label: "了解車險與投保前確認事項" }] },
  ] },
  { id: "order", title: "訂車與合約", items: [
    { id: "deposit", question: "付了訂金可以退嗎？貸款沒過怎麼辦？", answer: "要看契約、解除原因與適用規定。先談妥退訂、貸款未核准、額度不足或利率不符預期時的處理方式，連同已施工配件如何結算一起留下書面約定。保留契約與收據，有爭議時再依實際文件尋求消費諮詢。", sourceIds: ["consumer"], links: [{ href: "/guides#contract", label: "看訂車前合約核對清單" }] },
    { id: "model-year", question: "年式、出廠年份和領牌日期有什麼不同？", answer: "年式指車輛款式或配備版本，出廠年月指實際生產時間，領牌日則是車籍登記的日期。三者可能不同；詢價時分開列出，並確認是否已領牌、實際配備與保固起算方式。不要只用『今年的新車』作為約定。", sourceIds: ["consumer"], links: [{ href: "/guides#contract", label: "了解報價與車輛身分核對" }] },
    { id: "waiting-time", question: "訂車後多久能交？有車是不是就能馬上領？", answer: "交期還會受到車色與版本供應、貸款及文件進度、領牌與配件施工影響。先確認是否已有可分配車輛、目前完成哪個步驟，以及預估時間或約定期限。若有指定用車日期，下訂前就提出並談妥延誤處理。", sourceIds: [], links: [{ href: "/guides#delivery", label: "看訂車到交車的每一步" }] },
  ] },
  { id: "delivery", title: "領牌與交車", items: [
    { id: "payment-inspection", question: "要先付尾款還是先驗車？領牌前能看車嗎？", answer: "看車、付款、領牌及配件施工的順序，應在簽約時明確約定。希望領牌前看指定實車，就提前安排查看時間及付款條件；不要把別人的交車經驗當成所有車商都相同的流程。交車當天仍需依契約點交並記錄待處理事項。", sourceIds: ["consumer"], links: [{ href: "/guides#delivery", label: "看付款安排與交車檢查清單" }] },
    { id: "registration-documents", question: "領牌要準備什麼？證件什麼時候交？", answer: "個人、公司及委託代辦所需文件不同。個人身分證明與印章、車輛出廠及完稅資料、發票、保險等需按監理要求備妥，請承辦人提供完整清單。交付前確認用途、管道與歸還時間；本站諮詢表單不用填證件或銀行資料。", sourceIds: ["registration"], links: [{ href: "/guides#delivery", label: "看領牌文件與交車準備" }] },
    { id: "remote-purchase", question: "住外縣市也能買嗎？可以送到家嗎？", answer: "可以先遠端了解車款、需求與報價，再確認到店或文件安排。若希望其他地點交車，需依地點討論運送方式、費用、保險與驗收；交車地點、時程和可安排範圍以個案約定為準。", sourceIds: [], links: [{ href: "/guides#paperwork", label: "看跨縣市購車與交車流程" }] },
  ] },
  { id: "ownership", title: "換車與售後", items: [
    { id: "local-service", question: "在台北買車，之後保養一定要回台北嗎？", answer: "可先從 Taiwan Suzuki 官方保修據點查找附近服務中心，洽詢預約及車輛保養需求。保固依隨車文件與適用條件辦理；購車贈送保養或經銷商專案是否限店使用，另行確認。加裝配件也要分清施工與保固窗口。", sourceIds: ["service"], links: [{ href: "/guides#paperwork", label: "看跨縣市交車安排" }] },
    { id: "trade-in-tax", question: "沒有舊車也能減稅嗎？換購一定能折 10 萬嗎？", answer: "新購小客車減稅與汰舊換新是兩組條件。依財政部現行規則，符合條件的新購 2,000cc 以下小客車可減徵最高 5 萬元；符合汰舊換新可另申請最高 5 萬元，合計受已繳貨物稅額限制。純電車、小貨車等須另核對，不是每台車都能折 10 萬。", sourceIds: ["tax"], links: [{ href: "/guides#budget", label: "看換購預算注意事項" }] },
...
export const carFaqs: Record<CarId, FaqItem[]> = {
  swift: [
    ...
    { id: "swift-consumption", question: "SWIFT 官方油耗等於我的實際油耗嗎？", answer: "官方油耗是在指定條件下測得。短程、塞車、冷氣、載重和駕駛方式都會改變實際結果。可先用通勤里程做保守估算，交車後再以多次加油與里程紀錄觀察，不以單次最佳數字推估整年支出。", sourceIds: ["swift"], links: [{ href: "/guides#budget", label: "看每月養車費怎麼抓" }] },
  ],
  jimny: [
  ...
  carry: [
    ...
    { id: "carry-business-purchase", question: "CARRY 用公司名義購車，要先準備什麼？", answer: "先確認登記名義、用途、發票與付款方式，再由承辦人依公司及是否貸款提供文件清單。商用車的方案或減稅資格須另外核對，不能直接套用一般小客車優惠。", sourceIds: ["registration", "tax"], links: [{ href: "/guides#budget", label: "看換購預算注意事項" }] },
